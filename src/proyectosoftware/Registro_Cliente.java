...
public class Registro_Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        contraseña_usuario.setBackground(new java.awt.Color(234, 241, 246));
        contraseña_usuario.setBorder(null);
        contraseña_usuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                contraseña_usuarioActionPerformed(evt);
            }
        });
        getContentPane().add(contraseña_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 190, 20));
        ...
        getContentPane().add(apellido_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 190, 20));
        ...
        getContentPane().add(correo_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 286, 190, -1));
    ...
    private void contraseña_usuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_contraseña_usuarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_contraseña_usuarioActionPerformed
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        Atributos objetoA = new Atributos();
        objetoA.insertarCliente(nombre_usuario, apellido_usuario,
                correo_usuario, contraseña_usuario, telefono);
